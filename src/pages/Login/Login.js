        ...
        <form onSubmit={formik.handleSubmit} className="lg:w-1/2 xl:max-w-screen-sm">
            <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div className="cursor-pointer flex items-center">
                    ...
                    <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Felix 1004</div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div className="mt-8">
                            <div className="flex justify-between items-center">
                                ...
                                <div>
                                    <a href="true" className="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800 cursor-pointer">
                                        Quên mật khẩu ?
                                    </a>
                                </div>
                            </div>
